package io.baselogic.batch.threading.jobs;
...
import io.baselogic.batch.threading.config.JobConfig;
import io.baselogic.batch.threading.config.StepConfig;
...
public class JobTests {
    ...
    /**
     * Set parameter: 'threading=processor'
     * @return
     */
    ...
    /**
     * Set parameter: 'threading=writer'
     * @return
     */
    ...
    public void test__launch_job__all_steps() throws Exception {
        ...
        jobExecution.getStepExecutions().forEach(stepExecution -> {
            ...
            assertThat(stepExecution.getReadCount()).isGreaterThanOrEqualTo(100);
