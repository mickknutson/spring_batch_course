package io.baselogic.batch.async.config;

import io.baselogic.batch.async.listeners.ChunkAuditor;
import io.baselogic.batch.async.steps.ConsoleItemWriter;
import io.baselogic.batch.async.steps.EchoTasklet;
